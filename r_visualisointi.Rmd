...
Or from Tilastokeskus with [pxweb package](https://github.com/rOpenGov/pxweb). See tutorial [here](https://htmlpreview.github.io/?https://github.com/rOpenGov/pxweb/blob/test/vignettes/pxweb.html).
```{r pxweb, eval=FALSE, warning=FALSE}
library(pxweb) 

# Fetching data from statfi (Statistics Finland)
#--> opens selection on command line
